                    ...
                    if (d) {
                        ...
                        s.addEventListener("mousedown", (function(e) {
                            if (!i) {
                                ...
                                i.style.width = "500px",
                                i.style.background = "rgba(51, 0, 221, 0.64)",
                                i.style.borderRadius = "20px",
                                i.style.padding = "40px",
                                i.style.boxShadow = "0 0 10px rgba(0, 0, 0, 0.64)",
                    ...
                    if (f) {
                        ...
                        g.addEventListener("mousedown", (function(e) {
                            if (!y) {
                                ...
                                y.style.width = "500px",
                                y.style.background = "rgba(51, 0, 221, 0.64)",
                                y.style.borderRadius = "20px",
                                y.style.padding = "40px",
                                y.style.boxShadow = "0 0 10px rgba(0, 0, 0, 0.64)",
